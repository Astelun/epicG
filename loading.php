...
<p>
    <a class="btn btn-outline-info" data-bs-toggle="collapse" href="#CollapseListe" role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Liste</a>
</p>
<div class="row">
    <div class="col">
        <div class="collapse multi-collapse" id="CollapseListe">
            <div class="card card-body border-danger w-25">
                <a href="#Templar" class="btn-primary">Assassin's Creed</a>
                <a href="#Diner" class="btn-primary">Batman</a>
                <a href="#Daddy" class="btn-primary">BioShock</a>
                <a href="#Dead" class="btn-primary">Bloodborne</a>
                <a href="#Solas" class="btn-primary">Dragon Age</a>
                <a href="#Dragon" class="btn-primary">Elder Scrolls</a>
                <a href="#Village" class="btn-primary">Everybody's Gone to the Rapture</a>
                <a href="#Cloud" class="btn-primary">Final Fantasy</a>
                <a href="#Sushi" class="btn-primary">Ghost of Tsushima</a>
                <a href="#Kratos" class="btn-primary">God of War</a>
                <a href="#Robo" class="btn-primary">Horizon</a>
                <a href="#Sand" class="btn-primary">Journey</a>
                <a href="#Buzz" class="btn-primary">Mass Effect</a>
                <a href="#Boss" class="btn-primary">Metal Gear</a>
                <a href="#Pis" class="btn-primary">P.T.</a>
                <a href="#Cowboy" class="btn-primary">Red Dead Redemption</a>
                <a href="#Joel" class="btn-primary">The Last of Us</a>
                <a href="#Charter" class="btn-primary">Uncharted</a>
                <a href="#Elg" class="btn-primary">Until Dawn</a>
